...
{
    public class UsuarioCriarDtoParaUsuarioPerfilResolver : IValueResolver<UsuarioCriarDto, Usuario, IEnumerable<Domain.Entidades.Identity.UsuarioPerfil>>
    {
        public IEnumerable<Domain.Entidades.Identity.UsuarioPerfil> Resolve(UsuarioCriarDto source, Usuario destination, IEnumerable<Domain.Entidades.Identity.UsuarioPerfil> destMember, ResolutionContext context)
        {
