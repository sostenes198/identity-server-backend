...
{
    public class UsuarioAtualizarDtoParaUsuarioClaimResolver : IValueResolver<UsuarioAtualizarDto, Usuario, IEnumerable<Domain.Entidades.Identity.UsuarioClaim>>
    {
        public IEnumerable<Domain.Entidades.Identity.UsuarioClaim> Resolve(UsuarioAtualizarDto source, Usuario destination, IEnumerable<Domain.Entidades.Identity.UsuarioClaim> destMember, ResolutionContext context)
        {
